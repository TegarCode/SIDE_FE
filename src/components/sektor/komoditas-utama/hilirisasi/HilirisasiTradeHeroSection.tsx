...
export type HilirisasiMetricMode =
  | "total_export"
  | "total_import"
  | "total_trade";

type HilirisasiTradeHeroSectionProps = {
  metricMode: HilirisasiMetricMode;
  onMetricChange: (value: HilirisasiMetricMode) => void;
};

export function HilirisasiTradeHeroSection({
  metricMode,
  onMetricChange
}: HilirisasiTradeHeroSectionProps) {
  return (
    <section className="space-y-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-1">
          <h2 className="text-lg font-semibold tracking-tight text-slate-900">
            Perdagangan Indonesia Ke Global Sektor Hilirisasi
          </h2>
          <p className="max-w-3xl text-sm text-slate-600">
            Ringkasan analitik perdagangan sektor hilirisasi Indonesia ke global
