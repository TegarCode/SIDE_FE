...
type MineralKritisRouteTradeSectionHeaderProps = {
  metricMode: MineralKritisMetricMode;
  onMetricChange: (value: MineralKritisMetricMode) => void;
};

export function MineralKritisRouteTradeSectionHeader({
  metricMode,
  onMetricChange
}: MineralKritisRouteTradeSectionHeaderProps) {
  return (
    <section className="space-y-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-1">
          <h2 className="text-lg font-semibold tracking-tight text-slate-900">
            Perdagangan Rute Sektor Mineral Kritis
          </h2>
          <p className="max-w-3xl text-sm text-slate-600">
            Analitik lanjutan sektor mineral kritis berdasarkan negara asal,
            negara tujuan, dan HS Code terpilih untuk melihat total ekspor,
            total impor, atau total perdagangan.
          </p>
        </div>
