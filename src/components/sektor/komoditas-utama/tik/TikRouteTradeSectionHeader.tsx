...
type TikRouteTradeSectionHeaderProps = {
  metricMode: TikMetricMode;
  onMetricChange: (value: TikMetricMode) => void;
};

export function TikRouteTradeSectionHeader({
  metricMode,
  onMetricChange
}: TikRouteTradeSectionHeaderProps) {
  return (
    <section className="space-y-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-1">
          <h2 className="text-lg font-semibold tracking-tight text-slate-900">
            Perdagangan Rute Sektor TIK
          </h2>
          <p className="max-w-3xl text-sm text-slate-600">
            Analitik lanjutan sektor TIK berdasarkan negara asal, negara tujuan,
            dan HS Code terpilih untuk melihat total ekspor, total impor, atau
            total perdagangan.
          </p>
        </div>
