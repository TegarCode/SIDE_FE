...
export function HsStackedBarChart({
  years,
  series,
  height = 380,
  unit = "Ribu US$",
  filename = "hs-stacked-bar-chart",
  onRegisterDownload,
  exportTitle,
  exportSubtitle,
  exportFooter
  ...
  const option = React.useMemo(
    () => ({
      ...
      grid: { top: 18, right: 18, bottom: 84, left: 56, containLabel: true },
      xAxis: {
        type: "category",
    ...
    return (
      <div style={{ height }}>
        <EmptyStatePanel
          ...
          description="Data stacked HS belum tersedia untuk filter aktif."
          className="h-full"
        />
      </div>
    );
