...
export function PairLineChart({
  ...
  const option = React.useMemo(
    () => ({
      ...
      tooltip: {
        ...
        formatter: (params: {
          ...
          return [
            `<div style="font-weight:700;margin-bottom:6px;">${meta?.fullLabel ?? params.seriesName ?? "-"}</div>`,
    ...
    [maximumFractionDigits, series, seriesMeta, unit, years]
  );
