...
import { useKinerjaEkonomiManagementPage } from "@/hooks/admin-dashboard/useKinerjaEkonomiManagementPage";
...
export function AdminEconomicIndicatorDetailPage() {
  useDocumentTitle(`Detail Batch Kinerja Ekonomi | ${APP_NAME}`);
  ...
  const [editingRow, setEditingRow] = useState<KinerjaEkonomiRowRecord | null>(
    null
  );
  const [deletingRow, setDeletingRow] =
    useState<KinerjaEkonomiRowRecord | null>(null);
  ...
  } = useKinerjaEkonomiManagementPage({ page: 1, perPage: 1 }, batchId, {
    page: rowPage,
  ...
  const indicatorOptions = useMemo(
    () =>
      (optionsQuery.data?.indicators ?? []).map((item) => ({
        value: item.value,
        label: item.label
      })),
    [optionsQuery.data?.indicators]
  );
  ...
  return (
    <AdminManagementLayout
      title="Detail Batch Kinerja Ekonomi"
      description="Tinjau rincian batch data kinerja ekonomi, status validasi, dan daftar baris data yang masuk ke proses pengelolaan."
    >
      <div className="mx-auto w-full max-w-7xl space-y-5">
        <PageTitle
          title="Detail Batch Kinerja Ekonomi"
          description="Halaman ini menampilkan ringkasan batch, status proses, waktu pemrosesan, serta baris data kinerja ekonomi yang dapat diperiksa, diubah, atau dihapus sesuai hak akses."
          actions={
        ...
        {detailQuery.isLoading ? (
          ...
          <EmptyStatePanel
            ...
            description="Detail batch kinerja ekonomi belum berhasil dimuat atau data tidak tersedia."
            compact
          />
        ) : (
            ...
            <Card className="rounded-lg p-5 shadow-sm">
              <div className="flex flex-col gap-3 border-b border-slate-200 pb-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  <div className="text-lg font-semibold text-slate-900">
                    Daftar Baris Data Kinerja Ekonomi
                  </div>
              ...
              <div className="mt-4 overflow-hidden rounded-lg border border-slate-200">
                <SortableDataTable
                  ...
                  tableClassName="w-full min-w-[2120px] text-sm"
          ...
          onSubmit={async (row, payload) => {
            try {
              ...
              toast({
                ...
                description:
                  "Perubahan pada baris data kinerja ekonomi telah disimpan.",
                tone: "success"
              });
              setEditingRow(null);
            } catch (error) {
              toast({
                ...
                description: getApiErrorMessage(
                  error,
                  "Baris data kinerja ekonomi tidak berhasil disimpan."
                ),
                tone: "error"
              });
            }
        ...
        <ConfirmationModal
          ...
          title="Hapus Baris Data Kinerja Ekonomi"
          subtitle="Konfirmasi penghapusan satu baris data dari batch kinerja ekonomi."
          description={
            deletingRow
              ? "Baris data yang dipilih akan dihapus dari batch ini dan tidak lagi muncul pada daftar pemeriksaan."
              : "Baris data yang dipilih akan dihapus dari batch ini dan tidak lagi muncul pada daftar pemeriksaan."
          }
          confirmLabel="Hapus"
          confirmTone="danger"
          ...
          onConfirm={async () => {
            ...
            try {
              ...
              toast({
                ...
                description:
                  "Baris data kinerja ekonomi telah dihapus dari batch.",
                tone: "success"
              });
              setDeletingRow(null);
              setSelectedRowIds((current) => {
              ...
              toast({
                ...
                description: getApiErrorMessage(
                  error,
                  "Baris data kinerja ekonomi tidak berhasil dihapus."
                ),
                tone: "error"
              });
            }
        ...
        <ConfirmationModal
          ...
          subtitle="Konfirmasi penghapusan beberapa baris data dari batch kinerja ekonomi."
          ...
          onConfirm={async () => {
            ...
            try {
              ...
              toast({
                title: "Baris data berhasil dihapus",
                description: `${rowIds.length} baris data kinerja ekonomi telah dihapus dari batch.`,
                tone: "success"
              });
...
function BatchSummaryCards({ batch }: { batch: KinerjaEkonomiBatchRecord }) {
  const cards: Array<{
    label: string;
    value: ReactNode;
    description: string;
  ...
  }> = [
    {
      ...
      description: "Asal input batch kinerja ekonomi",
