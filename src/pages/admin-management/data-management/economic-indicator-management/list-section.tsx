...
import type { KinerjaEkonomiBatchRecord } from "@/type/admin-management/adminDashboardKinerjaEkonomi";
...
export function ListSection({
  ...
  batches: KinerjaEkonomiBatchRecord[];
  ...
  const [infoBatch, setInfoBatch] = useState<KinerjaEkonomiBatchRecord | null>(
    null
  );
...
function BatchInfoModal({
  ...
  batch: KinerjaEkonomiBatchRecord | null;
  uploaderNameById: Record<string, string>;
  onClose: () => void;
}) {
  return (
