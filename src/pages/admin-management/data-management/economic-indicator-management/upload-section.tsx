    ...
    <Card className="rounded-lg p-5 shadow-sm">
      <div className="border-b border-slate-200 pb-4">
        ...
        <div className="mt-1 text-sm text-slate-500">
          Sistem membaca contoh data untuk pratinjau, lalu berkas asli diproses
          oleh pekerjaan latar belakang setelah pemetaan dikirim.
        </div>
      </div>
      ...
      <div className="mt-4 space-y-4">
        <div className="overflow-hidden rounded-lg border border-blue-100 bg-blue-50">
          <div className="border-b border-blue-100 px-4 py-3">
            ...
            <p className="mt-1 text-xs leading-relaxed text-slate-600">
              Nama kolom Excel/CSV boleh berbeda, tetapi harus dipetakan ke
              field target di bawah setelah pratinjau terbaca.
            </p>
          </div>
        ...
        <Accordion
          ...
          description="Gunakan helper ini untuk memastikan kode pada file sesuai master yang tersedia."
          defaultOpen={false}
        ...
        >
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            <ReferenceCodePanel
              title="ID Indikator"
              items={filterItems(indicatorOptions)}
              emptyMessage="ID indikator tidak ditemukan."
            />
            <ReferenceCodePanel
              title="Kode Sumber"
        ...
        >
          ...
          <span className="mt-1 block text-xs leading-relaxed text-slate-500">
            ...
            {RECOMMENDED_UPLOAD_SIZE_LABEL} agar pratinjau dan impor tetap
            ringan.
          </span>
        </label>
        {previewLoading ? (
        ...
        {filename ? (
          <div className="grid gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-4 md:grid-cols-3">
            ...
            <div className="rounded-md bg-white/80 p-3 text-xs text-slate-600 ring-1 ring-emerald-100">
              Lanjutkan dengan memastikan pemetaan setiap field target sudah
              sesuai sebelum mengirim batch unggahan.
            </div>
          </div>
        ) : null}
