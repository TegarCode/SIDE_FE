...
import type { InvestmentBatchRecord } from "@/type/admin-management/adminDashboardInvestment";
...
export function ListSection({
  ...
  onWorkflow: (action: WorkflowAction, batch: InvestmentBatchRecord) => void;
}) {
  const [infoBatch, setInfoBatch] = useState<InvestmentBatchRecord | null>(
    null
  );
...
function BatchInfoModal({
  ...
  batch: InvestmentBatchRecord | null;
  uploaderNameById: Record<string, string>;
  onClose: () => void;
}) {
  return (
