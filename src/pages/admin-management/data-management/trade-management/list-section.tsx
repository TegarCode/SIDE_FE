...
import type { TradeBatchRecord } from "@/type/admin-management/adminDashboardTrade";
...
export function ListSection({
  ...
  onWorkflow: (action: WorkflowAction, batch: TradeBatchRecord) => void;
}) {
  const [infoBatch, setInfoBatch] = useState<TradeBatchRecord | null>(null);
