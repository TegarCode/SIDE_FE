    ...
    <Card className="rounded-lg p-5 shadow-sm">
      <div className="border-b border-slate-200 pb-4">
        ...
        <div className="mt-1 text-sm text-slate-500">
          ...
          di background job setelah pemetaan kolom dikirim.
        </div>
      </div>
      ...
      <div className="mt-4 space-y-4">
        <div className="overflow-hidden rounded-lg border border-blue-100 bg-blue-50">
          <div className="border-b border-blue-100 px-4 py-3">
            ...
            <p className="mt-1 text-xs leading-relaxed text-slate-600">
              Nama kolom CSV/Excel boleh berbeda, tetapi harus dipetakan ke
              field target perdagangan berikut.
            </p>
          </div>
        ...
        >
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            ...
            <ReferenceCodePanel
              title="Panjang HS"
              items={filterItems(hsLenOptions)}
              emptyMessage="Panjang HS tidak ditemukan."
            />
          </div>
        </Accordion>
        ...
        {filename ? (
          <div className="grid gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-4 md:grid-cols-3">
            ...
            <div className="rounded-md bg-white/80 p-3 text-xs text-slate-600 ring-1 ring-emerald-100">
              Pastikan pemetaan field target sudah sesuai sebelum mengirim batch
              unggahan.
            </div>
          </div>
        ) : null}
